...
public class Book {
	...
	//Object클래스의 메소드 toString을 override 하여 재정의
	@Override
	...
	public boolean equals(Object obj) {
		...
		if(title == null) { //원본 객체의 제목이 null이면 비교할 객체 제목도 null이어야 한다.
			...
			//두 객체의 title이 String의 equals로 비교하여 다른 경우에도 false 리턴
			return false;
		}
		...
		//위의 모든 조건을 통과한다 => 필드 값들이 다 같다. => 같은 객체로 판단한다.
		return true;
